<?php
/*
Template Name: Werkstatt Blog Übersicht
Description: Listet alle Beiträge vom Typ 'werkstatt' in einer Tabelle (Datum, Titel).
*/
get_header();
?>
<main id="site-content" role="main">
    ...
    <table class="presse-uebersicht" style="width:100%; border-collapse:collapse;">
        ...
        if ($presse_query->have_posts()) :
            ...
            ?>
            <tr>
                <td colspan="2" style="padding:8px;">Keine Beiträge vom Typ &quot;werkstatt&quot; gefunden.</td>
            </tr>
            <?php
        endif;
        ?>
